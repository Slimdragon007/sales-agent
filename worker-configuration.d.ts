/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 04c37a753d974887f2157043ca53e1ad)
...
interface __BaseEnv_Env {
	...
	TWILIO_VERIFIED_NUMBER: string;
	GOOGLE_CALENDAR_CLIENT_ID?: string;
	GOOGLE_CALENDAR_CLIENT_SECRET?: string;
	GOOGLE_CALENDAR_LOGIN_HINT?: string;
	VOICE_SAFETY_LEDGER: DurableObjectNamespace<import("./worker/index").VoiceSafetyLedger>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "VoiceSafetyLedger";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "OPENAI_PROJECT_ID" | "OPENAI_WEBHOOK_SECRET" | "PREVIEW_PASSWORD" | "TWILIO_ACCOUNT_SID" | "TWILIO_API_KEY_SID" | "TWILIO_API_KEY_SECRET" | "TWILIO_FROM_NUMBER" | "TWILIO_VERIFIED_NUMBER">> {}
}
